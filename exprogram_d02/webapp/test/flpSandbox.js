		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D02] 회원정보 조회 및 등록",
									"targetURL": "#cl4exprogramd02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl4exprogramd02-display": {
								"semanticObject": "cl4exprogramd02",
								"action": "display",
								"description": "회원정보조호",
								"title": "[D02] 회원정보 조회 및 등록",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl4.exprogramd02",
									"url": sap.ui.require.toUrl("cl4/exprogramd02")
								}
							}
						}
					}
